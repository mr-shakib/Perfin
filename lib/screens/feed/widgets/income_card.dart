  ...
  Widget build(BuildContext context) {
    return Consumer2<TransactionProvider, CurrencyProvider>(
      builder: (context, transactionProvider, currencyProvider, _) {
        ...
        final thisMonth = incomes.where((t) =>
            t.date.year == now.year && t.date.month == now.month).toList();
        final monthlyIncome = thisMonth.fold<double>(
          0.0,
          (sum, t) => sum + t.amount,
        );
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          currencyProvider.format(monthlyIncome),
                          style: const TextStyle(
                            fontSize: 48,
                            fontWeight: FontWeight.w700,
                            color: Colors.white,
